...
lang: 'sv'
pageTitle: 'Essäer om invandring: segaste myterna'
title: 'Essäer om invandring: myter om invandring'
...
faq:
  - q: "Myt 1: Flyttar folk till Finland i jakt på sociala förmåner?"
    a: "Den första sega myten om invandring är att folk skulle flytta till Finland i jakt på sociala förmåner. Det korrekta svaret är dock — med undantag för de senaste årens ukrainare — att majoriteten flyttar för att återförenas med familj eller för arbete."
  - q: "Myt 2: Kommer majoriteten av invandrarna från Afrika eller Mellanöstern?"
    a: "Den andra sega myten är att ett särskilt stort antal människor skulle flytta till Finland från Afrika eller Mellanöstern. I verkligheten kommer dock majoriteten av dem som flyttar till Finland från andra delar av Europa eller från Asien."
  - q: "Myt 3: Är invandrare lågutbildade?"
    a: "Den tredje sega myten är att de som flyttar till Finland skulle vara lågutbildade eller ha svaga kunskaper. De senaste statistikuppgifterna visar dock att andelen högutbildade bland invandrarna är 44 procent."
  - q: "Myt 4: Begår invandrare oproportionerligt många brott?"
    a: "Den fjärde och kanske segaste myten är att invandrare skulle begå en oproportionerligt stor andel brott. Statistiken visar att personer med utländsk bakgrund utgör 15 procent av alla misstänkta brottslingar, medan deras andel av befolkningen är 11 procent."
...
**Uppdaterat 25 juni 2026.** Min ståndpunkt är oförändrad men har utvecklats: det är viktigt att ärligt erkänna att mångfald och det nordiska tillitssamhället kan vara i spänning med varandra. Svaret är lyckad integration — inte uteslutning.

Läs mer om invandring: [tillsammans är vi starkare](/sv/blog/32/tillsammans-ar-vi-starkare/) samt [alla har rätt att vara stolta över sin existens](/sv/blog/40/alla-har-ratt-att-vara-stolt-over-sin-existens/). Läs mer i [mina texter om invandring](/sv/category/maahanmuutto/).
