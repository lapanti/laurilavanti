...
lang: 'sv'
pageTitle: 'Om invandringen — fakta och missuppfattning'
title: 'Essäer om invandring: om in­vandrings­debatten'
description: 'Invandringsdebatten domineras länge av kritiska röster. Det är dags att granska ämnet mer balanserat och faktabaserat — med fokus på vad forskning säger.'
...
*Det här är den första delen av serien "Essäer om invandring". Serien har sedan följts av texter om [invandringsvolymen](/sv/blog/24/essaer-om-invandring-invandringsvolymen/), [familjebaserad invandring](/sv/blog/26/om-familjebaserad-invandring/), [arbetsbaserad invandring](/sv/blog/28/om-arbetsbaserad-invandring/), [dem som kom för att studera](/sv/blog/29/om-dem-som-kom-for-att-studera/), [dem som beviljats asyl](/sv/blog/30/om-dem-som-beviljats-asyl/), [asylsökande](/sv/blog/31/om-asylsokande/) och [myter om invandring](/sv/blog/42/myter-om-invandring/).*
...
**Uppdaterat 25 juni 2026.** Min ståndpunkt är oförändrad men har utvecklats: precisa begrepp är fortfarande en förutsättning för en meningsfull diskussion, men det är också viktigt att ärligt erkänna att mångfald och det nordiska tillitssamhället kan vara i spänning med varandra. Svaret på den spänningen är lyckad integration — inte uteslutning.
