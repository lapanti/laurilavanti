...
lang: 'sv'
pageTitle: 'Tro är inte kunskapens värde – på fakta'
...
tags:
  ...
  - western-uusimaa
faq:
  - q: "Vad behöver en kommunal beslutsfattare veta?"
    a: "Med kommunalvalet i åtanke är det värt att ha ett par kunskapspärlor i minnet. Som till exempel att kommuner inte beslutar om läroplanen."
  - q: "Varför är kunskap ett bättre beslutsunderlag än tro?"
    a: "Listan över olika kunskapspärlor kunde fortsätta länge, men den väsentliga poängen är att information om de allra flesta ärenden faktiskt finns tillgänglig. Frågan är om man tar sig mödan att ta reda på det."
...
Jag har skrivit om faktabaserat beslutsfattande: [om min omröstning för Västernabanan](/sv/blog/46/jag-rostade-for-vasternabanan/), [om utbildning som kommunens viktigaste uppgift](/sv/blog/37/utbildning-ar-kommunens-viktigaste-uppgift/) och [om vuxnas ansvar för barns och ungas framtid](/sv/blog/21/ansvaret-ligger-hos-oss-vuxna/).
