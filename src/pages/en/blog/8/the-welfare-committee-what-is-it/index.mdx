...
lang: 'en'
pageTitle: 'The welfare committee — what is it?'
...
tags:
  ...
  - basic-welfare
faq:
  - q: "How does the board work in practice?"
    a: "In practice, when a resident files an appeal against a municipal decision relating to basic welfare — for example transport services or home care fees — the welfare committee decides whether to approve or reject the appeal."
  - q: "What can be learned from the experience?"
    a: "Not every decision necessarily feels humane, but the municipality's rules and legal provisions require drawing a line somewhere, and the welfare committee cannot always deviate from them."
...
**Updated 25 June 2026.** The welfare committee was dissolved following the 2023 sote reform, when responsibility for basic welfare transferred from municipalities to the Länsi-Uusimaa wellbeing services county. Equivalent appeals are now handled by the wellbeing services county's own bodies.
