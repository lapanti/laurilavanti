...
lang: 'en'
pageTitle: 'On the immigration debate — facts and myths'
title: 'Essays on immigration: on the immigration debate'
...
**Updated 25 June 2026.** My position has not changed, but has developed: precise terms are still a prerequisite for a useful conversation, but it is also important to acknowledge honestly that diversity and the Nordic trust society can be in tension with each other. The answer to that tension is successful integration — not exclusion.
