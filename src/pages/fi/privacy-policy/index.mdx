...
lang: fi
pageTitle: 'Tietosuojaseloste – henkilötietojen suoja'
title: 'Tieto­suoja­seloste'
intro: 'Mitä tietoja uutiskirjeen tilaajista kerätään, miten niitä käsitellään ja mitkä ovat tilaajan oikeudet henkilötietojensa suhteen.'
description: 'Lauri Lavannin uutiskirjeen tietosuojaseloste: mitä tietoja kerätään, miten niitä käsitellään ja mitkä ovat tilaajan oikeudet henkilötietojensa suhteen.'
...
Voit esittää tietosuojaoikeuksiasi koskevan pyynnön Lauri Lavannille sähköpostilla (lauri@lavanti.fi).
