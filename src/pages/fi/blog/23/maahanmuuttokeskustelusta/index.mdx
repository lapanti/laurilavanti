...
lang: 'fi'
pageTitle: 'Maahanmuuttokeskustelu – faktat ja myytit'
title: 'Esseitä maahan­muutosta: maahan­muutto­keskus­telusta'
...
## Miksi maahanmuutto­keskustelu on niin vaikeaa?
...
**Päivitetty 25.6.2026.** Kanta ei ole muuttunut, mutta kehittynyt: tarkat käsitteet ovat edelleen edellytys hyödylliselle keskustelulle, mutta on myös tärkeää tunnustaa rehellisesti, että monimuotoisuus ja pohjoismainen luottamusyhteiskunta voivat olla keskenään jännitteessä. Vastaus tähän jännitteeseen on onnistunut integraatio — ei poissulkeminen.
