...
lang: 'fi'
pageTitle: 'Luulo ei ole tiedon väärti – tieto vs. luulo'
title: 'Luulo ei ole tiedon väärti'
description: 'Puolueet markkinoivat itseään mielikuvilla. Kannattaa haastaa ehdokkaita ja kysyä, mihin väitteet perustuvat ja miten asiat oikeasti toimivat.'
...
tags:
  ...
  - western-uusimaa
faq:
  - q: "Mitä kuntapäättäjän pitää tietää?"
    a: "Kuntavaaleja ajatellen on hyvä pitää mielessä muutama tiedonjyvänen. Kuten se, että kunnissa ei päätetä opetussuunnitelmasta."
  - q: "Miksi tieto on parempi päätöspohja kuin luulo?"
    a: "Erilaisten tiedonjyvien luetteloa voisi jatkaa pitkään, mutta olennaista asiassa on, että suurimmasta osasta asioista tietoa on kyllä saatavilla. Kyse onkin siitä, ottaako asioista selvää."
...
Olen kirjoittanut faktoihin perustuvasta päätöksenteosta: [Länsirata-äänestyksestäni](/fi/blog/46/aanestin-lansiradan-puolesta/), [koulutuksesta kunnan tärkeimpänä tehtävänä](/fi/blog/37/koulutus-on-kunnan-tarkein-tehtava/) sekä [aikuisten vastuusta lasten ja nuorten tulevaisuudesta](/fi/blog/21/vastuu-on-meidan-aikuisten/).
