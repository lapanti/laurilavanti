...
lang: 'fi'
title: 'Perus­oikeuksia ei pidä kaventaa perus­teetta'
h1: 'Perus­oikeuksia ei pidä purkaa perus­teet­tomasti'
...
Digitaalisista oikeuksista ja teknologiasta olen kirjoittanut lisää: [passien biometristen tunnisteiden laajentamisesta](/fi/blog/48/passien-biometristen-tunnisteiden-kayttoa-ei-pida-laajentaa/), [digitaalisesta itsenäisyydestä](/fi/blog/51/digitaalinen-itsenaisyys-on-valttamattomyys/) sekä [siitä kuka päättää mistä puhumme](/fi/blog/43/kuka-paattaa-mista-puhumma/). Lue lisää [teknologiaa käsittelevistä kirjoituksistani](/fi/category/teknologia/).
