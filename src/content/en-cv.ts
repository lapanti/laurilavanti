export const fiduciariesTitle = 'Civic roles'
export const fiduciaries = [
    ...
    },
    {
        ...
        duty: 'Chair',
        endYear: 2025,
        organization: 'Greens of Kirkkonummi',
        startYear: 2025,
    },
    {
        duty: 'Deputy member of the premises services committee',
        endYear: 2025,
        organization: 'Kirkkonummi municipality',
        startYear: 2023,
    },
    {
        duty: 'Deputy member of the board',
        endYear: 2024,
        organization: 'Greens of Kirkkonummi',
        startYear: 2023,
    },
    {
        duty: 'Deputy member of the board of Western Uusimaa Rescue Services',
        endYear: 2025,
        organization: 'Western Uusimaa Wellbeing Services County',
        startYear: 2022,
    },
    {
        duty: 'Deputy member of the Finnish-language education committee',
        endYear: 2025,
        organization: 'Kirkkonummi municipality',
        startYear: 2021,
    },
    {
        duty: 'Member of the basic welfare section',
        endYear: 2022,
        organization: 'Kirkkonummi municipality',
        startYear: 2021,
    },
    {
        ...
        duty: 'International affairs captain',
        endYear: 2015,
        organization: 'Information Networks Guild Athene',
        startYear: 2015,
    },
    {
        description: ['Built team spirit and our ways of working, and led by example.'],
        duty: 'Team captain',
        endYear: 2015,
    ...
    },
    {
        ...
        duty: 'Board member, secretary, and communications lead',
        endYear: 2013,
        organization: 'Aalto Predators',
        startYear: 2013,
    },
...
export const jobExperiencesTitle = 'Work experience'
...
export const degrees = [
    ...
    {
        degree: 'Vocational qualification in data processing',
        description: [
        ...
        school: 'Omnia vocational college',
        startYear: 2007,
    },
    {
        ...
        endYear: 2011,
        location: 'Kirkkonummi',
        school: 'Masala upper secondary school',
        startYear: 2007,
    },
]
