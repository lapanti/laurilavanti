...
pageTitle: 'Hyvin suunniteltu on puoliksi tehty, mutta'
...
**Päivitetty 25.6.2026.** Gesterbyn koulukeskus rakennettiin, valmistui jopa aikataulua nopeammin ja on nyt yksi Kirkkonummen parhaista koulurakennuksista. Hyvä lopputulos — joskin turhan kauan odotettuna.

Olen kirjoittanut lisää koulutuksesta: [siitä miksi koulutus on kunnan tärkein tehtävä](/fi/blog/37/koulutus-on-kunnan-tarkein-tehtava/), [hallituksen koulutusleikkauksista](/fi/blog/22/yksi-askel-eteen-kaksi-taakse/) sekä [valtion kuntataloudelle aiheuttamasta paineesta](/fi/blog/38/kylma-riihi-kirkkonummelle/). Lue lisää [opetusta käsittelevistä kirjoituksistani](/fi/category/education/).
