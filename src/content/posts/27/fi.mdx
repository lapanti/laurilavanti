...
pageTitle: 'Suojellaanko koulutusta? Koulutusleikkaukset'
...
faq:
  ...
  - q: 'Riittävätkö indeksikorotukset paikkaamaan leikkaukset?'
    a: 'Hallitus lupasi, että koulutus olisi erityissuojelussa – toisin kävi. Kokonaisuudessaan opetusministeri näyttää unohtaneen, että investoiminen koulutukseen on investoiminen tulevaisuuteen.'
---
...
Laajemman kuvan siitä, miksi koulutus on kunnan ydintehtävä, tarjoaa kirjoitukseni [Koulutus on kunnan tärkein tehtävä](/fi/blog/37/koulutus-on-kunnan-tarkein-tehtava/). Lue lisää koulutuskirjoituksistani [opetus-kategoriasta](/fi/category/education/).
