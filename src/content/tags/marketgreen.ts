...
export const markkinavihreaTag: LocalTag = {
    descriptions: {
        en: [
            ...
            'Markkinavihreä uskoo, että markkinatalous on tehokkain tunnettu tapa jakaa resursseja — mutta vain silloin, kun ulkoisvaikutukset on hinnoiteltu, kilpailu on reilua ja saastuttaja maksaa saastuttamisensa. Verotuksen painopiste siirretään työstä haittoihin, ei julkisen sektorin osuuden kasvattamiseen itseisarvoisesti. Suomi tarvitsee uskottavan markkinaliberaalin Vihreän äänen eduskuntaan, jotta ilmasto, oikeudet ja kilpailukyky ratkaistaan yhdessä eikä toisiaan vastaan vaihtokauppana.',
            'Käynnistin kesäkuussa 2026 yhdessä kymmenien Vihreiden talousosaajien kanssa vaihdavihreisiin.fi-kampanjan samanaikaisesti Kokoomuksen puoluekokouksen kanssa. Lähtökohta oli yksinkertainen: liberaaleille ja sosiaaliliberaaleille ei ole enää kotia keskustaoikeistossa, ja Vihreät on jo nyt Suomen johtava markkinaliberaali puolue. Kampanja julkaisi Markkinavihreän manifestin ja avoimen WhatsApp-yhteisön, jossa keskustelu jatkuu edelleen.',
            'Markkinavihreys ei ole brändäysharjoitus. Se on sisällöllinen talouspoliittinen kanta: haittaverotusta työn verotuksen sijaan, kilpailua vakiintuneiden toimijoiden suojelun sijaan, avoimia hankintoja toimittajariippuvuuden sijaan, ja valtio, joka ostaa teknologiaa omilla ehdoillaan. Tämä sivu kytkee kannan tekoälyn aikakauden teollisuuspolitiikkaan, julkishankintojen siirrettävyyteen ja laajempaan Vihreiden talouslinjaan.',
        ],
        sv: [
            'En marknadsgrön anser att marknadsekonomin är det effektivaste kända sättet att fördela resurser — men bara när externa effekter är prissatta, konkurrensen är rättvis och förorening kostar förorenaren. Beskattningens tyngdpunkt flyttas från arbete till skador, inte mot att öka den offentliga sektorns andel för sin egen skull. Finland behöver en trovärdig marknadsliberal grön röst i riksdagen så att klimat, rättigheter och konkurrenskraft avgörs tillsammans i stället för att handlas mot varandra.',
            'Tillsammans med dussintals ekonomiskt kunniga gröna startade jag i juni 2026 kampanjen vaihdavihreisiin.fi samtidigt som Samlingspartiets kongress. Utgångspunkten var enkel: liberaler och socialliberaler har inte längre ett hem i mittenhögern, och De gröna är redan landets ledande marknadsliberala parti. Kampanjen publicerade ett Marknadsgrönt manifest och en öppen WhatsApp-gemenskap — samtalet fortsätter.',
