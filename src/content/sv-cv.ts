...
export const fiduciaries = [
    ...
    {
        description: [
            'Ledde Kyrkslätts Gröna genom kommunalvalet 2025 — befäste partiets ställning som det tredje största partiet i Kyrkslätt med betydande tillväxt i medlemsantal.',
            'Byggde och ledde hela kandidatlistan; samarbetade direkt med valledaren om strategi och genomförande.',
            'Förbättrade organisationen och arbetssätten för att minska beroendet av enskilda personer.',
        ],
        duty: 'Ordförande',
        endYear: 2025,
        organization: 'Kyrkslätts Gröna',
        startYear: 2025,
    },
    {
        duty: 'Ersättare i nämnden för lokalservice',
        endYear: 2025,
        organization: 'Kyrkslätt kommun',
        startYear: 2023,
    },
    {
        duty: 'Ersättare i styrelsen',
        endYear: 2024,
        organization: 'Kyrkslätts Gröna',
        startYear: 2023,
    },
    {
        duty: 'Ersättare i direktionen för Västra Nylands räddningsverk',
        endYear: 2025,
        organization: 'Västra Nylands välfärdsområde',
        startYear: 2022,
    },
    {
        duty: 'Ersättare i finska fostrings- och utbildningsnämnden',
        endYear: 2025,
        organization: 'Kyrkslätt kommun',
        startYear: 2021,
    },
    {
        duty: 'Ledamot i grundtrygghetssektionen',
        endYear: 2022,
        organization: 'Kyrkslätt kommun',
        startYear: 2021,
    },
    {
        description: [
            'Första styrelseledamot i Athene med ansvar för internationella studenter — rollen var ny eftersom studieprogrammet nyligen hade öppnats för internationella studenter på magisternivå.',
    ...
    {
        description: [
            'Tog laget från näst sista plats i serien till universitätsmästare under min tid.',
            'Startade direktsändning av våra matcher — sändningen trendade på Reddit och resulterade i en intervju med en av våra kommentatorer i ett amerikanskt morgonradioprogram.',
            'Byggde upp rekryteringen parallellt med tävlingsresultaten.',
        ],
        duty: 'Styrelseordförande',
        endYear: 2015,
...
export const jobExperiences = [
    ...
    },
    {
        ...
        description: [
            'Ansvarade för teamets tekniska inriktning och arkitekturbeslut.',
            'Drev förbättringar av arbetssätten i hela IT-organisationen, inte bara i det närmaste teamet.',
            'Ledde utvecklarrekryteringen för teamet: intervjuer, anställningar och introduktion av nya utvecklare i kodbasen och processerna.',
        ],
        endYear: 2024,
        location: 'Helsingfors',
        startYear: 2022,
    ...
    },
    {
        ...
        description: [
            'Mjukvaruutvecklare på företagets huvudprodukt — ett molnbaserat ekonomirapporteringsverktyg med Java-backend och HTML/JavaScript/CSS-gränssnitt.',
        ],
        endYear: 2014,
        location: 'Helsingfors',
        startYear: 2014,
    ...
    },
    {
        ...
        description: [
            'Praktikant som byggde ett internt ärendehanteringssystem för produktägare i en Scrum-baserad process — implementerat i Python.',
        ],
        endYear: 2013,
        location: 'Esbo',
        startYear: 2013,
