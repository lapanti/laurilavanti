...
export const fiduciaries = [
    ...
    {
        description: [
            'Johdatin joukkueen sarjan toisiksi viimeiseltä paikalta yliopiston mestaruuteen kauteni aikana.',
            'Aloitin otteluiden suoratoiston — lähetys trendasi Redditissä ja johti yhden selostajamme haastatteluun yhdysvaltalaisessa aamuradio-ohjelmassa.',
            'Kehitin rekrytointia kilpailullisten tulosten ohella.',
        ],
...
export const jobExperiences = [
    ...
    },
    {
        ...
        description: [
            'Ohjelmistokehittäjä yrityksen päätuotteessa — pilvipalveluna toteutetussa talousraportointityökalussa, Java-taustajärjestelmällä ja HTML/JavaScript/CSS-käyttöliittymällä.',
        ],
        endYear: 2014,
        location: 'Helsinki',
        startYear: 2014,
    ...
    },
    {
        ...
        description: [
            'Harjoittelija rakentamassa sisäistä tikettijärjestelmää tuoteomistajien Scrum-prosessin tueksi — toteutettu Pythonilla.',
        ],
        endYear: 2013,
        location: 'Espoo',
        startYear: 2013,
